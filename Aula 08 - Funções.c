#include <stdio.h>
#include "BibliotecaViana.c"	// Ao importar biblioteca que não seja nativa do C, tem que colocar aspas duplas.
...
int main (){					
	...
	delay(3000);			// Pausa tela por 3s. Também é possível utilizar função "sleep()"
